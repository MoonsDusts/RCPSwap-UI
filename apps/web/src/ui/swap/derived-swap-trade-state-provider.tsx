...
interface State {
  mutate: {
    ...
    setTradeToConfirm: (trade: UseTradeReturn | undefined) => void
  ...
  state: {
    showConfirm: boolean
    tradeToConfirm: UseTradeReturn | undefined
...
const DerivedSwapTradeStateProvider: FC<DerivedSwapTradeStateProviderProps> = ({
  ...
  const [tradeToConfirm, setTradeToConfirm] = useState<
    UseTradeReturn | undefined
  >()
